...
AWS_ACCESS_KEY_ID = os.environ.get('AWS_SECRET_KEY_ID', 'AKIAIRPVDUBCWWG5VD4A')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET__ACCESS_KEY', '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')
